...
@Component({
  ...
  template: `
    <div class="flex flex-col h-full w-full">
      <div class="h-12 border-b p-4 ml-2 flex items-center">
        <mat-icon color="primary">diversity_1</mat-icon>
        <span class="ml-4 font-bold text-slate-700">JobBoard B2B</span>
      </div>
